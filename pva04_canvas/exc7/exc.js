...
const handleBrickCollision = () => {
    ...
    document.getElementById('score').innerText = gameLoop.brickCollisions;

    if(gameLoop.brickCollisions % 3 === 0){
        gameLoop.interval /= 1.2;
        gameLoop.difficulty += 1;
        document.getElementById('difficulty').innerText = gameLoop.difficulty;
    }
}
...
const moveBall = (x, y) => {
    ...
    if(gameLoop.running) calculateBallPositions(x, y);
